...
static __constant uint2 const Keccak_f1600_RC[24] = {
        (uint2) (0x00000001, 0x00000000), (uint2) (0x00008082, 0x00000000), (uint2) (0x0000808a, 0x80000000), (uint2) (0x80008000, 0x80000000),
        (uint2) (0x0000808b, 0x00000000), (uint2) (0x80000001, 0x00000000), (uint2) (0x80008081, 0x80000000), (uint2) (0x00008009, 0x80000000),
        (uint2) (0x0000008a, 0x00000000), (uint2) (0x00000088, 0x00000000), (uint2) (0x80008009, 0x00000000), (uint2) (0x8000000a, 0x00000000),
        (uint2) (0x8000808b, 0x00000000), (uint2) (0x0000008b, 0x80000000), (uint2) (0x00008089, 0x80000000), (uint2) (0x00008003, 0x80000000),
        (uint2) (0x00008002, 0x80000000), (uint2) (0x00000080, 0x80000000), (uint2) (0x0000800a, 0x00000000), (uint2) (0x8000000a, 0x80000000),
        (uint2) (0x80008081, 0x80000000), (uint2) (0x00008080, 0x80000000), (uint2) (0x80000001, 0x00000000), (uint2) (0x80008008, 0x80000000),
};
...
#    define MIX(x)                                                                                                                                                       \
        do {                                                                                                                                                             \
            ...
            __global hash128_t const* g_dag = (__global hash128_t const*) _g_dag2[idx & 1];                                                                              \
...
__attribute__((reqd_work_group_size(WORKSIZE, 1, 1))) __kernel void search(__global struct SearchResults* g_output, __constant uint2 const* g_header,
                                                                           __global ulong8 const* _g_dag0, __global ulong8 const* _g_dag1, uint dag_size,
                                                                           ulong start_nonce, ulong target) {
    if (g_output->abort) return;
...
#pragma unroll 1
    ...
    if (get_local_id(0) == 0) atomic_inc(&g_output->hashCount);
...
static void SHA3_512(uint2* s) {
    ...
    for (uint i = 9; i != 25; ++i) st[i] = (uint2) (0);
...
__kernel void GenerateDAG(uint start, __global const uint16* _Cache, __global uint16* _DAG0, __global uint16* _DAG1, uint light_size) {
    ...
    __global Node* DAG;
#ifdef SPLIT_DAG
    if (NodeIdx & 2) DAG = (__global Node*) _DAG1;
    else
